        ...
        <form class="form-inline mr-auto">
          ...
          <div class="search-element">
            ...
            <div class="search-result">
              ...
              <div class="search-item">
                <a href="#">
                  <img class="mr-3 rounded" width="30" src="stisla/dist/assets/img/products/product-3-50.png"
                    alt="product">
              ...
              <div class="search-item">
                <a href="#">
                  <img class="mr-3 rounded" width="30" src="stisla/dist/assets/img/products/product-2-50.png"
                    alt="product">
                  Drone X2 New Gen-7
                </a>
              </div>
              <div class="search-item">
                <a href="#">
                  <img class="mr-3 rounded" width="30" src="stisla/dist/assets/img/products/product-1-50.png"
                    alt="product">
                  Headphone Blitz
                </a>
              </div>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class=active><a class="nav-link" href="/contacts"><i class="far fa-square"></i> <span>Kritik dan Sara
                </span></a></li>
